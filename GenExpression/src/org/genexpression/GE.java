...
public class GE {
	...
	public static void main(String[] args) throws Exception {
		 ...
		 * ATG-/AT-Number and then the String
		 * "Keine passende ATG-Nummer gefunden"
		 */
		...
		matrixATG = ATGzuExprParser(ATGfile, AT_Expressionfile);
		...
		/*
		 * matrixATG.
		 * exportMatrix("C:/Users/denis/Desktop/RELATIVIERTE matrixausgabevon "
		 * +AT_Expressionfile.substring(AT_Expressionfile.lastIndexOf("/") +
		 * 1));
		 */
	 ...
	 * 
	 * @param atgnr
	 *            - The ATG-Number to which you want to find the prober
	 *            AT-Number
	 * @param h
	 *            - ArrayList of ATG-Objects (ATGnr, ATnr, pfam)
	 ...
	 * 
	 * @param atnr
	 *            - The AT-Number to which you want to find the prober
	 *            ATG-Number
	 * @param h
	 *            - ArrayList of ATG-Object (ATGnr, ATnr, pfam)
	...
	public static void ausgabe(ArrayList<ATG> h) {
		for (int i = 0; i < h.size(); i++) {
			System.out.println(h.get(i).getATGnr() + ", " + h.get(i).getATnr() + ", " + h.get(i).getPfam());
		}
	}

	/**
	 * Parses a Expressionfile-Matrix (with AT-ID and Treatments) to a new
	 * Expressionfile-Matrix (with ATG-ID instead of AT-ID)
	 * 
	 * @param atgfile
	 *            - Genechipfile that translates ATG to AT-ID-Numbers
	 * @param atfile
	 *            - Matrixfile with AT-ID, Treatments and Expressiondata
	...
	public static Matrix_Create ATGzuExprParser(String atgfile, String atfile) throws IOException {
		...
		/*
		 * goes through every line and translates the first Element (the
		 * AT-Number) to his proper ATG-Number with the help of the ATGListeTest
		 */
